...
import { userProfile, dummyRecords } from '@/lib/dummy-data';
...
export default function ProfilePage() {
  const formattedJoinDate = new Date(userProfile.joinDate).toLocaleDateString(
    'ko-KR',
    {
      year: 'numeric',
      month: 'long',
        ...
        <div className="bg-card rounded-2xl p-5">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <div className="flex items-center gap-1 text-muted-foreground text-sm mt-1">
                ...
                <span>{formattedJoinDate} 가입</span>
              </div>
            </div>
          </div>
          ...
          <div className="mt-5 pt-5 border-t border-border">
            <div className="grid grid-cols-2 gap-4 mb-5">
              ...
              <div className="text-center bg-muted rounded-xl py-3">
                <p className="text-2xl font-bold text-foreground">
                  {new Set(dummyRecords.map((r) => r.location)).size}
                </p>
            ...
            <div className="grid grid-cols-2 gap-2">
              {(Object.keys(categoryEmoji) as Category[]).map((cat) => {
